...
class compleatedTaskList extends StatefulWidget {
  const compleatedTaskList({super.key});

  @override
  State<compleatedTaskList> createState() => _compleatedTaskListState();
}

class _compleatedTaskListState extends State<compleatedTaskList> {
  @override
  void initState() {
    callData();
    super.initState();
